...
manviGUI = Tk()
manviGUI.title(" Disease Prediction Based on Symptoms")
manviGUI.configure()
...
S1En = OptionMenu(manviGUI, Symptom1, *OPTIONS)
S1En.grid(row=7, column=2)

S2En = OptionMenu(manviGUI, Symptom2, *OPTIONS)
S2En.grid(row=8, column=2)

S3En = OptionMenu(manviGUI, Symptom3, *OPTIONS)
S3En.grid(row=9, column=2)

S4En = OptionMenu(manviGUI, Symptom4, *OPTIONS)
S4En.grid(row=10, column=2)

S5En = OptionMenu(manviGUI, Symptom5, *OPTIONS)
S5En.grid(row=11, column=2)

NameLb = Label(manviGUI, text="")
...
t3 = Text(manviGUI, height=2, width=30, bg="grey")
